					...
					<div className="w-full relative z-[2] md:px-12 max-md:px-5">
						<ul className="lg:w-9/12 text-[14px] pt-16 text-[#7d8590] space-y-1">
							<li>
								...
								average time to fix 50% of flaws as 198 days vs. ViewMarket&apos;s fix
								rates of 72% of flaws with in 28 days which is at a minimum of
								7X faster when compared..
							</li>
							<br />
							<li>
								<sup id="footnote-2">2</sup>The Total Economic Impact™ Of ViewMarket
							...
							<li>
								...
								traders around the world using ViewMarket.
				<Link href="https://viewmarket.com/blog/2023-01-25-2-million-traders-and-counting">
									Read the blog post.
								</Link>
							</li>
						</ul>
