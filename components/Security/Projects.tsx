...
import { arcGreen, criticalSec } from "@public";
					...
					<div className="py-4 mb-2 w-full">
						<motion.div
							...
							<a
								...
								Dive into ViewMarket Advanced Security
								<svg
				...
				<motion.div
					...
					<div className="py-4 text-left">
						...
						<p className="mb-3 md:text-xl text-base font-medium text-white">
							vulnerability fixes with ViewMarket<sup>1</sup>
						</p>
					</div>
				</motion.div>
			</div>
