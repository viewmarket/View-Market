			...
			<div className="flex md:pl-10 space-x-3 md:space-x-10">
				...
				<div className="md:w-10/12 mb-24 w-full">
					...
					<motion.h3
						...
						<span className="text-[#7c72ff]">Accelerate your trading</span>
						<br />
						Our AI-powered platform with 110+ trading tools increases your market success.
					</motion.h3>
				</div>
				...
				<HoverCard
					...
					<div className="overflow-auto md:flex flex-col md:space-y-20 flex-1 py-20 md:p-10 p-5 my-6 justify-between md:min-w-[400px]">
						<p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
							<span className="text-white font-medium">ViewMarket AI Tools </span>
							automate your trading analysis, risk management, and execution with intelligent
					...
					<HoverCard
						...
						<div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
							<p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
								...
								ViewMarket Workspace{" "}
							</span>
							offers a complete trading environment in seconds. Analyze, backtest, execute,
							and manage positions from any market.
							</p>
							<div>
								<Link
									...
									Check out ViewMarket Workspace
									<svg
										xmlns="http://www.w3.org/2000/svg"
					...
					<HoverCard
						...
						<div className="md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
							<p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
								...
								puts global markets in your pocket, so you never miss a trading
