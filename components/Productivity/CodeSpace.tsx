...
import { arcGreenPro, proCoverTop, proSideArc } from "@public";
					...
					<div className="py-4 mb-2 w-full">
						<motion.div
							...
							<h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]">
								<span className="font-semibold text-white">ViewMarket AI Assistant</span>{" "}
							...
							<Link
								...
								Explore ViewMarket AI Assistant
								<svg
					...
					<div className="w-full">
						<div className="py-4 text-left">
							...
							<p className="mb-3 md:text-xl text-base font-medium text-white">
								in trader productivity after three <br /> years with ViewMarket
							</p>
						</div>
						<Link
							onMouseEnter={() => setHovered(true)}
