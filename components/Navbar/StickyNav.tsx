						...
						<div className="w-full flex items-center max-lg:flex-col relative">
							...
							<div className="flex lg:flex-row flex-col text-[16px] justify-start max-lg:w-full flex-auto lg:space-x-4  text-white">
								...
								<Link
									...
									className={` max-lg:pt-2 ${collab1 ? "lg:text-white" : ""} ${
										collab || smallNav
											? "lg:text-white max-lg:pb-6"
											: "max-lg:hidden"
									} `}>
									...
									<div
										className={`w-10/12 max-lg:hidden mx-auto mt-1 h-[1px] bg-white scale-0 transition ease-in duration-100 ${
											collab1 ? "scale-100 text-white" : ""
										} ${collab ? "scale-100 text-white" : ""}`}
									/>
								</Link>
								<Link
									href="#security"
									...
									<div
										className={`w-10/12 max-lg:hidden mx-auto mt-1 h-[1px] bg-white scale-0 transition ease-in duration-100 ${
											security1 ? "scale-100 text-white" : ""
										} ${security ? "scale-100 text-white" : ""}`}
									/>
								</Link>
							</div>
							<div
