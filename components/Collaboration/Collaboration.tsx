		...
		<div className="w-full pt-12">
			<div className="flex md:pl-7 space-x-3 md:space-x-10">
				...
				<motion.div
					...
					<h3
						...
						<span className="text-[#7c72ff]">Connect with traders worldwide</span>
						<br />
						ViewMarket helps traders share insights and strategies together.
					</h3>
				</motion.div>
			...
			<div className="flex justify-between items-center">
				<div className="flex justify-between md:space-x-10 max-md:flex-col">
					<HoverCard
						...
						<div className="md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
							<p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
								<span className="text-white font-semibold">Trading Signals</span>{" "}
						automated alerts and notifications keep you informed of market
						opportunities and portfolio changes.
							</p>
							<div>
								<Link
					...
					<HoverCard
						...
						<div className="md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
							<p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
								<span className="text-white font-semibold">ViewMarket Mobile</span>
						fits your trading portfolio in your pocket, so you never miss a market
						move while on the go.
							</p>
							<div>
								<Link
			...
			<HoverCard
				...
				<div className="md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between">
					<p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
						<span className="text-white font-medium">ViewMarket Pro</span> lets
					you access premium trading tools and advanced market insights.
					</p>
					<div>
						<Link
				...
				<div className="py-3 mb-2 flex flex-col w-full gap-y-5">
					<div className="py-10">
						<h2 className="mb-4 lg:text-7xl md:text-4xl text-3xl font-bold text-white relative">
							Over 2 million traders <br /> trust ViewMarket
							<sup className="text-[30px]"> 3</sup>
						</h2>
						<p className="mb-4 md:text-xl text-[16px] text-[#7d8590]">
							Whether you&apos;re managing institutional portfolios or just starting to trade,
					ViewMarket is your platform. <br /> Join the world&apos;s most advanced trading
					platform to access global markets with confidence.
					<br />
