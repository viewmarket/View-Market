...
import { arcPink, issueColab } from "@public";
						...
						<motion.div
							...
							<h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]">
								<span className="font-semibold text-white">
									ViewMarket Issues and ViewMarket Projects
								</span>{" "}
				...
				<motion.div
					...
					<div className="py-4 text-left">
						...
						<p className="mb-3 md:text-xl text-base font-medium text-white">
							reduction in onboarding <br /> time with ViewMarket<sup>2</sup>
						</p>
					</div>
				</motion.div>
			</div>
